 ...
 */
class getRealmRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RealmRepository' shared autowired service.
     *
     * @return \App\Repository\RealmRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RealmRepository.php';

        return $container->privates['App\\Repository\\RealmRepository'] = new \App\Repository\RealmRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
