 ...
 */
class getTownRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TownRepository.php';

        return $container->privates['App\\Repository\\TownRepository'] = new \App\Repository\TownRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
